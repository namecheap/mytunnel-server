...
describe('Client', () => {
    ...
    it('should respond with 502 Bad Gateway on HTTP request error before headers sent', async () => {
        // Agent that returns error in createConnection
        ...
        assert.equal(res.statusCode, 502, 'Should return 502 status code');
        ...
        assert.equal(body, 'Tunnel: Bad Gateway', 'Should return Bad Gateway message');
