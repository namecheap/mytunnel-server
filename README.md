...
This repo is the server component. If you are just looking for the CLI mytunnel app, see (https://github.com/namecheap/easy-tunnel).
...
git clone git://github.com/namecheap/mytunnel-server.git
cd mytunnel-server
npm install
